...
class MultiTabApp(ctk.CTk, TabOperationsMixin, FileOperationsMixin, SearchOperationsMixin, SettingsOperationsMixin):
    def __init__(self):
        super().__init__()
        self._ensure_app_directory() # 専用ディレクトリの作成
    ...
    def _create_widgets(self):
        ...
        self.btn_new = self._add_toolbar_button("new_file", self.add_new_tab)
        self.btn_open = self._add_toolbar_button("open_file", self.open_file)
    ...
    def _add_toolbar_button(self, key, command):
